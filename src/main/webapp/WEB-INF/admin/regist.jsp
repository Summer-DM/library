                    ...
                    <div class="widget-content">
                        <div class="padd">
                            ...
                            <form class="form-horizontal" role="form" method="post"
                                  action="http://localhost:8080/library/admin/regist">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-lg-8 col-md-8 col-xs-8">
                                        <input id="username" name="username" type="text" required="required" value=""
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-lg-8 col-md-8 col-xs-8">
                                        <input id="sex" name="sex" type="text" required="required" value=""
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-lg-8 col-md-8 col-xs-8">
                                        <input id="tel" name="tel" type="text" required="required" value=""
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-lg-8 col-md-8 col-xs-8">
                                        <input id="institute" name="institute" type="text" required="required" value=""
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-lg-8 col-md-8 col-xs-8">
                                        <input id="profession" name="profession" type="text" required="required"
                                               value="" class="form-control" placeholder="学院">
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label class="col-lg-4 col-md-4 col-xs-4 control-label">班级</label>
                                    <div class="col-lg-8 col-md-8 col-xs-8">
                                        <input id="classname" name="classname" type="text" required="required" value=""
